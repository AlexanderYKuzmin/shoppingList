...
class ShopItemFragment() : Fragment() {
    ...
    var screenMode: String = NODE_UNKNOWN
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("ShopItemFragment", "screenMode = $screenMode, id = $shopItemId")
    ...
    private fun observeViewModel() {
        viewModel.processIsFinished.observe(viewLifecycleOwner, Observer {
    ...
    private fun parseParams() {
        ...
        if (mode != MODE_ADD && mode != MODE_EDIT) {
            throw java.lang.RuntimeException("Unknowing mode")
        }

        screenMode = mode
        if (screenMode == MODE_EDIT) {
            if (!args.containsKey(SHOP_ITEM_ID)) {
                throw java.lang.RuntimeException("No id")
            }
        }
    ...
    companion object {
        ...
        private const val NODE_UNKNOWN = ""
